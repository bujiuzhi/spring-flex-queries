...
VALUES (UNIX_TIMESTAMP(), 'QQ', '张三', '李四', '00:05:23', '2023-12-01 10:00:00', '张三', '李四',
        '你好，我是张三，你有什么需求吗？', '张三', '2023-12-01 10:00:00', '张三', '2023-12-01 10:00:00'),
       (UNIX_TIMESTAMP() + 1, '彭博社', '王五', '赵六', '00:03:45', '2023-12-10 11:00:00', '赵六', '王五',
        '我想买一些股票，你有什么推荐吗？', '赵六', '2023-12-10 11:00:00', '赵六', '2023-12-10 11:00:00'),
       (UNIX_TIMESTAMP() + 2, '微信', '李七', '王八', '00:07:12', '2023-12-20 12:00:00', '李七', '王八',
