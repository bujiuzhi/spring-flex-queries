...
-- 插入数据
INSERT INTO stg_model_job (job_id, model_id, model_version, model_name, model_category, algorithm_name,
...
VALUES ('20230101010000-mod001-1dot0', 'mod001', '1.0', '信用评分模型', '信用模型', 'k-means',
        '{"clusters": 5, "iterations": 100}', '训练数据', 50.0, '运行中',
       ...
       ('20230101080000-mod001-2dot0', 'mod001', '2.0', '信用评分模型', '信用模型', 'k-means',
        '{"clusters": 5, "iterations": 100}', '训练数据', 0.0, '运行失败',
        '指标预警', '2023-01-10 13:00:00', '', '信用评分模型训练', '{"accuracy": 0.92}', 'credit_score_training',
        '2022-01-01', '2022-06-01', 70.0, 30.0, '随机', '{"AUC": 0.90}', '每天', '每天',
        '最大化AUC值', '{"always": true}', '信用风险', '<PMML_data>', '<Sample_data>',
        '张三', '2023-01-01 08:00:00', '李四', '2023-01-10 14:00:00'),
       ('20230201093000-mod002-2dot0', 'mod002', '2.0', '客户流失预测', '预警模型', 'logistic_regression',
        '{"C": 1.0, "max_iter": 200}', '测试数据', 50.0, '运行中',
       ...
       ('20230301100000-mod003-1dot0', 'mod003', '1.0', '商品推荐模型', '归因模型', 'neural_network',
        '{"layers": [64, 32, 16], "epochs": 10}', '验证数据', 0.0, '没有状态',
        '定期触发', '2023-03-20 16:00:00', '', '个性化商品推荐模型训练', '{"recall": 0.93}',
       ...
       ('20230401120000-mod004-3dot0', 'mod004', '3.0', '故障预测模型', '预警模型', 'decision_tree',
        '{"depth": 10, "min_samples_split": 20}', '训练数据', 100.0, '运行成功',
       ...
       ('20230501130000-mod005-2dot0', 'mod005', '2.0', '市场细分模型', '归因模型', 'svm',
        '{"kernel": "rbf", "C": 1.0}', '测试数据', 50.0, '运行中', '手工触发', '2023-05-30 18:00:00', '',
        '市场细分与消费者行为分析', '{"accuracy": 0.89}',
        'market_segmentation', '2022-05-01', '2022-10-01', 55.0, 45.0, '系统', '{"F1": 0.91}', '每月', '每月',
